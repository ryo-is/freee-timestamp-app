...
import 'package:freee_time_stamp/pages/user_info.dart';
...
class FreeePage extends StatefulWidget {
  const FreeePage({super.key, required this.title});

  final String title;

  @override
  State<FreeePage> createState() => _FreeePageState();
}

class _FreeePageState extends State<FreeePage> with RouteAware {
